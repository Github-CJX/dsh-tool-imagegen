 ...
 *   maxRetries?, retryDelayMs? } where image is { b64, mime } for
 *   image-to-image, and maxRetries/retryDelayMs tune the transient-failure
 *   retry (defaults: 3 retries, 800 ms exponential backoff).
