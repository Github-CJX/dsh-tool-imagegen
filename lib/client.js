window.__ModuleLoader__.load({
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(BooleanField, {
						...
						onEdit: (text) => {
							props.edit("output_format_enabled", text);
						},
						onReset: () => {
							props.resetField("output_format_enabled");
						}
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ValueField, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(BooleanField, {
						...
						...state.style_enabled,
						onEdit: (text) => {
							props.edit("style_enabled", text);
						},
						onReset: () => {
							props.resetField("style_enabled");
						}
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ValueField, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(BooleanField, {
						...
						onEdit: (text) => {
							props.edit("watermark_enabled", text);
						},
						onReset: () => {
							props.resetField("watermark_enabled");
						}
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ValueField, {
	...
	*  the panel filters by substring, and the current draft is marked. */
	function ValueField(props) {
		...
		const matches = props.comboOptions !== void 0 ? props.comboOptions.filter((option) => option.toLowerCase().includes(needle)) : [];
		(0, react.useEffect)(() => {
			setFocusIndex(0);
		}, [needle]);
		const combo = props.comboOptions !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					...
					onFocus: () => {
						if (!props.disabled && props.text.trim() !== "") setOpen(true);
					},
					onKeyDown: (event) => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				combo ?? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					id: props.id,
