window.__ModuleLoader__.load({
	...
	*/
	...
	const css$1 = "/**\n * dsh-tool-imagegen settings card styles. Mirrors the official plugin-config\n * card chrome (@deepseek-ai/dsh-client-ui-settings-plugins PluginCard + fields)\n * so the card reads as a sibling of the bash / agent-loop / web-search cards;\n * colors ride the dsh --dsw-* tokens.\n */\n\n.dsh-tig_card_r946zp {\n  list-style: none;\n  border: 1px solid var(--dsw-alias-border-l2);\n  border-radius: 12px;\n  background: var(--dsw-alias-bg-layer-3);\n  transition: border-color 0.16s, background 0.16s;\n}\n\n.dsh-tig_card_r946zp:hover {\n  border-color: var(--dsw-alias-label-dimmed);\n}\n\n/* An open card reads as the one being worked on, not merely taller. */\n.dsh-tig_card_r946zp:has(.dsh-tig_body_r946zp) {\n  background: var(--dsw-alias-bg-layer-2);\n  border-color: var(--dsw-alias-label-dimmed);\n}\n\n.dsh-tig_header_r946zp {\n  width: 100%;\n  appearance: none;\n  border: 0;\n  background: none;\n  font: inherit;\n  color: inherit;\n  text-align: left;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 14px 16px;\n  border-radius: 12px;\n}\n\n.dsh-tig_header_r946zp:focus-visible {\n  outline: 2px solid var(--dsw-alias-brand-primary);\n  outline-offset: -2px;\n}\n\n.dsh-tig_headText_r946zp {\n  flex: 1;\n  min-width: 0;\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n\n.dsh-tig_name_r946zp {\n  font-size: 15px;\n  font-weight: 600;\n  line-height: 1.4;\n  color: var(--dsw-alias-label-primary);\n}\n\n.dsh-tig_description_r946zp {\n  font-size: 13px;\n  line-height: 1.5;\n  color: var(--dsw-alias-label-tertiary);\n}\n\n.dsh-tig_chevron_r946zp,\n.dsh-tig_chevronOpen_r946zp {\n  flex: none;\n  color: var(--dsw-alias-label-tertiary);\n  transition: transform 0.16s;\n}\n\n.dsh-tig_chevronOpen_r946zp {\n  transform: rotate(180deg);\n}\n\n/* Carried on the header so a collapsed card still says it holds edits. */\n.dsh-tig_pending_r946zp {\n  flex: none;\n  border-radius: 999px;\n  padding: 1px 8px;\n  font-size: 11px;\n  line-height: 17px;\n  font-weight: 500;\n  white-space: nowrap;\n  background: var(--dsw-alias-bg-module-platform);\n  color: var(--dsw-alias-label-secondary);\n}\n\n.dsh-tig_body_r946zp {\n  border-top: 1px solid var(--dsw-alias-border-l2);\n  margin: 0 16px;\n  padding-bottom: 8px;\n}\n\n/* --- fields (mirror of the official plugin-config fields) --------------------- */\n\n.dsh-tig_field_r946zp {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n  padding: 12px 0;\n}\n\n.dsh-tig_field_r946zp + .dsh-tig_field_r946zp {\n  border-top: 1px solid var(--dsw-alias-border-l2);\n}\n\n.dsh-tig_head_r946zp {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n\n.dsh-tig_label_r946zp {\n  flex: 1;\n  min-width: 0;\n  font-size: 13px;\n  font-weight: 500;\n  line-height: 1.5;\n  color: var(--dsw-alias-label-primary);\n}\n\n.dsh-tig_badges_r946zp {\n  display: inline-flex;\n  align-items: center;\n  gap: 8px;\n}\n\n.dsh-tig_badge_r946zp {\n  border-radius: 999px;\n  padding: 1px 8px;\n  font-size: 11px;\n  line-height: 17px;\n  white-space: nowrap;\n  font-weight: 500;\n  background: var(--dsw-alias-bg-module-platform);\n  color: var(--dsw-alias-label-secondary);\n}\n\n.dsh-tig_reset_r946zp {\n  border: none;\n  background: none;\n  padding: 0;\n  font: inherit;\n  font-size: 12px;\n  line-height: 1.5;\n  color: var(--dsw-alias-label-secondary);\n  cursor: pointer;\n}\n\n.dsh-tig_reset_r946zp:hover:not(:disabled) {\n  color: var(--dsw-alias-label-primary);\n}\n\n.dsh-tig_reset_r946zp:disabled {\n  cursor: default;\n  opacity: 0.5;\n}\n\n.dsh-tig_input_r946zp,\n.dsh-tig_select_r946zp {\n  height: 34px;\n  padding: 0 12px;\n  border: 1px solid var(--dsw-alias-border-l2);\n  border-radius: 8px;\n  background: var(--dsw-alias-bg-layer-3);\n  font: inherit;\n  font-size: 13px;\n  line-height: 1.5;\n  color: var(--dsw-alias-label-primary);\n  outline: none;\n}\n\n.dsh-tig_input_r946zp:focus-visible,\n.dsh-tig_select_r946zp:focus-visible {\n  border-color: var(--dsw-alias-brand-primary);\n}\n\n.dsh-tig_input_r946zp:disabled,\n.dsh-tig_select_r946zp:disabled {\n  color: var(--dsw-alias-label-tertiary);\n  cursor: default;\n}\n\n.dsh-tig_inputInvalid_r946zp {\n  height: 34px;\n  padding: 0 12px;\n  border: 1px solid var(--dsw-alias-label-error);\n  border-radius: 8px;\n  background: var(--dsw-alias-bg-layer-3);\n  font: inherit;\n  font-size: 13px;\n  line-height: 1.5;\n  color: var(--dsw-alias-label-primary);\n  outline: none;\n}\n\n.dsh-tig_hint_r946zp,\n.dsh-tig_invalid_r946zp {\n  margin: 0;\n  font-size: 12px;\n  line-height: 1.5;\n}\n\n.dsh-tig_hint_r946zp {\n  color: var(--dsw-alias-label-tertiary);\n}\n\n.dsh-tig_invalid_r946zp {\n  color: var(--dsw-alias-label-error);\n}\n\n.dsh-tig_readOnly_r946zp,\n.dsh-tig_notExposed_r946zp {\n  margin: 12px 0 0;\n  font-size: 12px;\n  line-height: 1.5;\n  color: var(--dsw-alias-label-tertiary);\n}\n\n/* --- footer (mirror of the official card footer) ------------------------------ */\n\n.dsh-tig_footer_r946zp {\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  gap: 8px;\n  padding: 12px 0 4px;\n  border-top: 1px solid var(--dsw-alias-border-l2);\n}\n\n.dsh-tig_failed_r946zp {\n  flex: 1;\n  min-width: 0;\n  margin: 0;\n  font-size: 12px;\n  line-height: 1.5;\n  color: var(--dsw-alias-label-error);\n}\n\n.dsh-tig_discard_r946zp,\n.dsh-tig_save_r946zp {\n  appearance: none;\n  border: 1px solid transparent;\n  border-radius: 8px;\n  padding: 5px 14px;\n  font: inherit;\n  font-size: 13px;\n  line-height: 1.5;\n  cursor: pointer;\n}\n\n.dsh-tig_discard_r946zp {\n  border-color: var(--dsw-alias-border-l2);\n  background: none;\n  color: var(--dsw-alias-label-secondary);\n}\n\n.dsh-tig_discard_r946zp:hover:not(:disabled) {\n  color: var(--dsw-alias-label-primary);\n  border-color: var(--dsw-alias-label-dimmed);\n}\n\n.dsh-tig_save_r946zp {\n  background: var(--dsw-alias-label-primary);\n  color: var(--dsw-alias-bg-layer-3);\n}\n\n.dsh-tig_discard_r946zp:disabled,\n.dsh-tig_save_r946zp:disabled {\n  opacity: 0.4;\n  cursor: default;\n}\n\n.dsh-tig_discard_r946zp:focus-visible,\n.dsh-tig_save_r946zp:focus-visible {\n  outline: 2px solid var(--dsw-alias-brand-primary);\n  outline-offset: 1px;\n}\n\n@media (prefers-reduced-motion: reduce) {\n  .dsh-tig_card_r946zp, .dsh-tig_chevron_r946zp, .dsh-tig_chevronOpen_r946zp {\n    transition: none;\n  }\n}\n";
	...
	var settings_card_module_css_default = {
		"card": "dsh-tig_card_r946zp",
		"body": "dsh-tig_body_r946zp",
		"header": "dsh-tig_header_r946zp",
		"headText": "dsh-tig_headText_r946zp",
		"name": "dsh-tig_name_r946zp",
		"description": "dsh-tig_description_r946zp",
		"chevron": "dsh-tig_chevron_r946zp",
		"chevronOpen": "dsh-tig_chevronOpen_r946zp",
		"pending": "dsh-tig_pending_r946zp",
		"field": "dsh-tig_field_r946zp",
		"head": "dsh-tig_head_r946zp",
		"label": "dsh-tig_label_r946zp",
		"badges": "dsh-tig_badges_r946zp",
		"badge": "dsh-tig_badge_r946zp",
		"reset": "dsh-tig_reset_r946zp",
		"input": "dsh-tig_input_r946zp",
		"select": "dsh-tig_select_r946zp",
		"inputInvalid": "dsh-tig_inputInvalid_r946zp",
		"hint": "dsh-tig_hint_r946zp",
		"invalid": "dsh-tig_invalid_r946zp",
		"readOnly": "dsh-tig_readOnly_r946zp",
		"notExposed": "dsh-tig_notExposed_r946zp",
		"footer": "dsh-tig_footer_r946zp",
		"failed": "dsh-tig_failed_r946zp",
		"discard": "dsh-tig_discard_r946zp",
		"save": "dsh-tig_save_r946zp"
	};
	//#endregion
	...
	*/
	...
	const css = "/**\n * dsh-tool-imagegen inline conversation view. Mirrors the platform tool-row\n * chrome so generated images read as a sibling of the bash/read/search rows,\n * riding the dsh --dsw-* tokens.\n */\n\n.dsh-tig_root_1t4mk3a {\n  display: flex;\n  flex-direction: column;\n  border: 1px solid var(--dsw-alias-border-l2);\n  border-radius: 12px;\n  background: var(--dsw-alias-bg-layer-3);\n  overflow: hidden;\n}\n\n.dsh-tig_head_1t4mk3a {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  min-width: 0;\n  height: 40px;\n  padding: 0 14px;\n  border-bottom: 1px solid var(--dsw-alias-border-l2);\n}\n\n.dsh-tig_title_1t4mk3a {\n  color: var(--dsw-alias-label-secondary);\n  flex: none;\n  font-size: 13px;\n  font-weight: 600;\n  line-height: 24px;\n}\n\n.dsh-tig_meta_1t4mk3a {\n  color: var(--dsw-alias-label-tertiary);\n  flex: auto;\n  min-width: 0;\n  font-size: 12px;\n  line-height: 24px;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  overflow: hidden;\n}\n\n.dsh-tig_state_1t4mk3a {\n  color: var(--dsw-alias-state-error-primary);\n  flex: none;\n  font-size: 12px;\n  line-height: 24px;\n}\n\n.dsh-tig_body_1t4mk3a {\n  display: flex;\n  flex-direction: column;\n  gap: 14px;\n  padding: 14px;\n}\n\n.dsh-tig_image_1t4mk3a {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n  min-width: 0;\n}\n\n.dsh-tig_frame_1t4mk3a {\n  position: relative;\n  border: 1px solid var(--dsw-alias-border-l2);\n  border-radius: 10px;\n  background: var(--dsw-alias-bg-layer-2);\n  overflow: hidden;\n}\n\n.dsh-tig_img_1t4mk3a {\n  display: block;\n  max-width: 100%;\n  max-height: 480px;\n  margin: 0 auto;\n}\n\n.dsh-tig_download_1t4mk3a {\n  position: absolute;\n  right: 10px;\n  bottom: 10px;\n  padding: 4px 10px;\n  border: 1px solid var(--dsw-alias-border-l2);\n  border-radius: 6px;\n  background: color-mix(in srgb, var(--dsw-alias-bg-layer-3) 86%, transparent);\n  color: var(--dsw-alias-label-secondary);\n  font-size: 12px;\n  line-height: 18px;\n  text-decoration: none;\n  opacity: 0;\n  transition: opacity 0.15s ease;\n}\n\n.dsh-tig_frame_1t4mk3a:hover .dsh-tig_download_1t4mk3a,\n.dsh-tig_frame_1t4mk3a:focus-within .dsh-tig_download_1t4mk3a {\n  opacity: 1;\n}\n\n.dsh-tig_download_1t4mk3a:hover {\n  color: var(--dsw-alias-label-primary);\n  border-color: var(--dsw-alias-border-l1);\n}\n\n.dsh-tig_caption_1t4mk3a {\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n  min-width: 0;\n}\n\n.dsh-tig_captionLine_1t4mk3a {\n  margin: 0;\n  font-size: 12px;\n  line-height: 1.5;\n  color: var(--dsw-alias-label-tertiary);\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  overflow: hidden;\n}\n\n.dsh-tig_captionPrompt_1t4mk3a {\n  color: var(--dsw-alias-label-secondary);\n}\n\n/* --- running / loading / error states ---------------------------------------- */\n\n.dsh-tig_running_1t4mk3a {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  min-height: 40px;\n  padding: 10px 14px;\n  color: var(--dsw-alias-label-secondary);\n  font-size: 13px;\n  line-height: 20px;\n}\n\n.dsh-tig_spinner_1t4mk3a {\n  flex: none;\n  width: 14px;\n  height: 14px;\n  border: 2px solid var(--dsw-alias-border-l2);\n  border-top-color: var(--dsw-alias-label-tertiary);\n  border-radius: 50%;\n  animation: dsh-tool-imagegen-spin 0.8s linear infinite;\n}\n\n@keyframes dsh-tool-imagegen-spin {\n  to { transform: rotate(360deg); }\n}\n\n.dsh-tig_loading_1t4mk3a {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  min-height: 120px;\n  color: var(--dsw-alias-label-tertiary);\n  font-size: 12px;\n  line-height: 20px;\n}\n\n.dsh-tig_loadFailed_1t4mk3a {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  min-height: 120px;\n  padding: 0 14px;\n  color: var(--dsw-alias-state-error-primary);\n  font-size: 12px;\n  line-height: 20px;\n  text-align: center;\n}\n\n@media (prefers-reduced-motion: reduce) {\n  .dsh-tig_spinner_1t4mk3a {\n    animation: none;\n  }\n}\n";
	...
	var generate_image_view_module_css_default = {
		"root": "dsh-tig_root_1t4mk3a",
		"head": "dsh-tig_head_1t4mk3a",
		"title": "dsh-tig_title_1t4mk3a",
		"meta": "dsh-tig_meta_1t4mk3a",
		"state": "dsh-tig_state_1t4mk3a",
		"body": "dsh-tig_body_1t4mk3a",
		"image": "dsh-tig_image_1t4mk3a",
		"frame": "dsh-tig_frame_1t4mk3a",
		"img": "dsh-tig_img_1t4mk3a",
		"download": "dsh-tig_download_1t4mk3a",
		"caption": "dsh-tig_caption_1t4mk3a",
		"captionLine": "dsh-tig_captionLine_1t4mk3a",
		"captionPrompt": "dsh-tig_captionPrompt_1t4mk3a",
		"running": "dsh-tig_running_1t4mk3a",
		"spinner": "dsh-tig_spinner_1t4mk3a",
		"loading": "dsh-tig_loading_1t4mk3a",
		"loadFailed": "dsh-tig_loadFailed_1t4mk3a"
	};
	//#endregion
