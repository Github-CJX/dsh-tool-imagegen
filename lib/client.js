window.__ModuleLoader__.load({
	...
	*/
	...
	var generate_image_view_module_css_default = {
		...
		"promptRow": "dsh-tig_promptRow_lw9tw4",
		"promptToggle": "dsh-tig_promptToggle_lw9tw4",
	...
	* `<img>` inline.
	*
	* Display style: the shipped tool-card chrome (header row + padded body, image
	* capped at 480px tall and centered in a full-width frame, hover actions pinned
	* to the frame's bottom-right corner, meta/prompt caption lines underneath).
	* The frame keeps the full body width so the action cluster always has room —
	* a hugging frame left the bottom-right buttons cramped for tall portrait
	* images.
	*
	...
	*/
	...
	function ImageRow(props) {
		...
		const [promptClipped, setPromptClipped] = (0, react.useState)(false);
		(0, react.useLayoutEffect)(() => {
			const el = promptRef.current;
			if (el === null) return;
			const measure = () => {
				setPromptClipped(el.scrollWidth > el.clientWidth + 1);
			};
			measure();
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					image.prompt !== "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: generate_image_view_module_css_default.promptRow,
						"data-expanded": promptOpen ? "true" : void 0,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							ref: promptRef,
						...
						}), promptOpen || promptClipped ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: generate_image_view_module_css_default.promptToggle,
							"aria-expanded": promptOpen,
							title: promptOpen ? t("toolviewPromptCollapse") : t("toolviewPromptExpand"),
							onClick: () => setPromptOpen(!promptOpen),
							children: promptOpen ? t("toolviewPromptCollapse") : t("toolviewPromptExpand")
						}) : null]
					}) : null,
